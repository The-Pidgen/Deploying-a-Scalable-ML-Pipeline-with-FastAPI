...
GitHub Repo Link: https://github.com/The-Pidgen/Deploying-a-Scalable-ML-Pipeline-with-FastAPI.git
...
* Create a directory for the project and initialize git.
    * As you work on the code, continually commit changes. Trained models you want to use in production must be
      committed to GitHub.
